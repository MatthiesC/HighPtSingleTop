...
MatchHists::MatchHists(Context & ctx, const string & dirname):
  ...
  hist_deltaR_topQuark_topRecoJet = book<TH1F>("deltaR_topQuark_topRecoJet", "#DeltaR(gen. t quark, HOTVR t-tag)", nBins_dR, 0, 5);
  hist_deltaPhi_topQuark_topRecoJet = book<TH1F>("deltaPhi_topQuark_topRecoJet", "#Delta#phi(gen. t quark, HOTVR t-tag)", nBins_dPhi, 0, M_PI);
  ...
  hist_deltaR_WBoson_topRecoJet = book<TH1F>("deltaR_WBoson_topRecoJet", "#DeltaR(gen. assoc. W, HOTVR t-tag)", nBins_dR, 0, 5);
  hist_deltaPhi_WBoson_topRecoJet = book<TH1F>("deltaPhi_WBoson_topRecoJet", "#Delta#phi(gen. assoc. W, HOTVR t-tag)", nBins_dPhi, 0, M_PI);
  ...
  hist_deltaR_topQuark_topRecoJet_Pt0to400 = book<TH1F>("deltaR_topQuark_topRecoJet_Pt0to400", "#DeltaR(gen. t quark, HOTVR t-tag)", nBins_dR, 0, 5);
  hist_deltaPhi_topQuark_topRecoJet_Pt0to400 = book<TH1F>("deltaPhi_topQuark_topRecoJet_Pt0to400", "#Delta#phi(gen. t quark, HOTVR t-tag)", nBins_dPhi, 0, M_PI);
  hist_deltaR_topQuark_recoLepton_Pt0to400 = book<TH1F>("deltaR_topQuark_recoLepton_Pt0to400", "#DeltaR(gen. t quark, rec. lepton)", nBins_dR, 0, 5);
  hist_deltaPhi_topQuark_recoLepton_Pt0to400 = book<TH1F>("deltaPhi_topQuark_recoLepton_Pt0to400", "#Delta#phi(gen. t quark, rec. lepton)", nBins_dPhi, 0, M_PI);

  hist_deltaR_WBoson_topRecoJet_Pt0to400 = book<TH1F>("deltaR_WBoson_topRecoJet_Pt0to400", "#DeltaR(gen. assoc. W, HOTVR t-tag)", nBins_dR, 0, 5);
  hist_deltaPhi_WBoson_topRecoJet_Pt0to400 = book<TH1F>("deltaPhi_WBoson_topRecoJet_Pt0to400", "#Delta#phi(gen. assoc. W, HOTVR t-tag)", nBins_dPhi, 0, M_PI);
  hist_deltaR_WBoson_recoLepton_Pt0to400 = book<TH1F>("deltaR_WBoson_recoLepton_Pt0to400", "#DeltaR(gen. assoc. W, rec. lepton)", nBins_dR, 0, 5);
  hist_deltaPhi_WBoson_recoLepton_Pt0to400 = book<TH1F>("deltaPhi_WBoson_recoLepton_Pt0to400", "#Delta#phi(gen. assoc. W, rec. lepton)", nBins_dPhi, 0, M_PI);

  hist_deltaR_topQuark_topRecoJet_Pt400toInf = book<TH1F>("deltaR_topQuark_topRecoJet_Pt400toInf", "#DeltaR(gen. t quark, HOTVR t-tag)", nBins_dR_lowRes, 0, 5);
  hist_deltaPhi_topQuark_topRecoJet_Pt400toInf = book<TH1F>("deltaPhi_topQuark_topRecoJet_Pt400toInf", "#Delta#phi(gen. t quark, HOTVR t-tag)", nBins_dPhi_lowRes, 0, M_PI);
  hist_deltaR_topQuark_recoLepton_Pt400toInf = book<TH1F>("deltaR_topQuark_recoLepton_Pt400toInf", "#DeltaR(gen. t quark, rec. lepton)", nBins_dR_lowRes, 0, 5);
  hist_deltaPhi_topQuark_recoLepton_Pt400toInf = book<TH1F>("deltaPhi_topQuark_recoLepton_Pt400toInf", "#Delta#phi(gen. t quark, rec. lepton)", nBins_dPhi_lowRes, 0, M_PI);

  hist_deltaR_WBoson_topRecoJet_Pt400toInf = book<TH1F>("deltaR_WBoson_topRecoJet_Pt400toInf", "#DeltaR(gen. assoc. W, HOTVR t-tag)", nBins_dR_lowRes, 0, 5);
  hist_deltaPhi_WBoson_topRecoJet_Pt400toInf = book<TH1F>("deltaPhi_WBoson_topRecoJet_Pt400toInf", "#Delta#phi(gen. assoc. W, HOTVR t-tag)", nBins_dPhi_lowRes, 0, M_PI);
  hist_deltaR_WBoson_recoLepton_Pt400toInf = book<TH1F>("deltaR_WBoson_recoLepton_Pt400toInf", "#DeltaR(gen. assoc. W, rec. lepton)", nBins_dR_lowRes, 0, 5);
  hist_deltaPhi_WBoson_recoLepton_Pt400toInf = book<TH1F>("deltaPhi_WBoson_recoLepton_Pt400toInf", "#Delta#phi(gen. assoc. W, rec. lepton)", nBins_dPhi_lowRes, 0, M_PI);
