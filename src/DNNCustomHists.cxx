#include "UHH2/HighPtSingleTop/include/DNNCustomHists.h"
...
DNNCustomHists::DNNCustomHists(Context & ctx, const string & dirname, double arg_MIN_PT, double arg_MAX_PT):
  Hists(ctx, dirname) {
...
void DNNCustomHists::fill(const uhh2::Event & event) {
