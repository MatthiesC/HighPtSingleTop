...
InExAK4Jets::InExAK4Jets(Context & ctx,
  ...
  h_Ex_ak4_bLoose(ctx.get_handle<vector<Jet>>("ExBJetsLoose"+h_name_postfix)),
  h_Ex_ak4_bMedium(ctx.get_handle<vector<Jet>>("ExBJetsMedium"+h_name_postfix)),
  h_Ex_ak4_bTight(ctx.get_handle<vector<Jet>>("ExBJetsTight"+h_name_postfix)),
  h_Ex_ak4_bAnalysis(ctx.get_handle<vector<Jet>>("ExBJets"+h_name_postfix)),
  h_In_ak4(ctx.get_handle<vector<Jet>>("InJets"+h_name_postfix)),
  h_In_ak4_bLoose(ctx.get_handle<vector<Jet>>("InBJetsLoose"+h_name_postfix)),
  h_In_ak4_bMedium(ctx.get_handle<vector<Jet>>("InBJetsMedium"+h_name_postfix)),
  h_In_ak4_bTight(ctx.get_handle<vector<Jet>>("InBJetsTight"+h_name_postfix)),
  h_In_ak4_bAnalysis(ctx.get_handle<vector<Jet>>("InBJets"+h_name_postfix)),
