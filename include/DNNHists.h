...
class DNNHists: public uhh2::Hists {
 ...
 public:
  ...
  DNNHists(uhh2::Context & ctx, const std::string & dirname, const std::vector<std::string> inputs, const std::vector<DNNInput> inputs_info, const std::string binning_var_name, const double arg_MIN_VAL = 0., const double arg_MAX_VAL = 99999.);
