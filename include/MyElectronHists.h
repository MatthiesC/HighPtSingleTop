...
protected:
    ...
    // here directly.
    TH1F *number, *pt, *eta, *phi, *deltaPhiMET, *isolation, *isolation_wide, *isolation_log, *charge, *ptrel, *deltaRmin, *deltaPhimin;
    TH1F *eff_sub, *eff_tot, *pt_response;

    TH2F *deltaRmin_ptrel, *eta_phi, *eta_iso, *iso_phi;
};
