...
int TMVAClassificationANN( TString myMethodList = "" )
{
   ...
   // After speaking with Paolo on July 11th, 2018
   // AdaBoost
   Use["BDT_50_25_05"]  = 0;
   Use["BDT_80_25_05"]  = 0;
   ...
   Use["BDT"] = 0; //Use["BDT_50_25_03_10"]  = 0;
   ...
   std::cout << std::endl;
   std::cout << "==> Start TMVAClassificationANN" << std::endl;
   ...
   TString outfileName( "TMVAOutputANN.root" );
   ...
   factory->AddVariable("tmva_hotvr1_pt", "HOTVRJet1 pT", "GeV", 'F' );
   ...
   TString dirname = "/nfs/dust/cms/user/matthies/HighPtSingleTop/80X_v5/MainSelection/Muon/workdir_mainsel_muo/";

   std::vector<TFile*> input;
   
   // Signal samples
   input.push_back( TFile::Open( dirname+"uhh2.AnalysisModuleRunner.MC.ST_tW_signal_T_0.root" ) );
   input.push_back( TFile::Open( dirname+"uhh2.AnalysisModuleRunner.MC.ST_tW_signal_Tbar_0.root" ) );

   // TTbar background samples
   input.push_back( TFile::Open( dirname+"uhh2.AnalysisModuleRunner.MC.TTbarM0to700_0.root" ) );
   input.push_back( TFile::Open( dirname+"uhh2.AnalysisModuleRunner.MC.TTbarM700to1000_0.root" ) );
   input.push_back( TFile::Open( dirname+"uhh2.AnalysisModuleRunner.MC.TTbarM1000toInf_0.root" ) );
 ...
 factory->PrepareTrainingAndTestTree( mycuts, mycutb,
				      "nTrain_Signal=0:nTrain_Background=0:SplitMode=Random:SplitSeed=0:NormMode=NumEvents:!V" ); // Find a value for SplitSeed that avoids Negative Bins
   // ---- Book MVA methods
   //
   ...
   if (Use["MLP"])
      factory->BookMethod( TMVA::Types::kMLP, "MLP", "H:!V:NeuronType=sigmoid:VarTransform=N:NCycles=100:HiddenLayers=N,N+10,5:TestRate=5:!UseRegulator" );
   ...
   if (Use["BDT20"]) // 
     factory->BookMethod( TMVA::Types::kBDT, "BDT20",
			  "!H:!V:NTrees=20:MinNodeSize=5%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=20" );
   if (Use["BDT50"]) // 
     factory->BookMethod( TMVA::Types::kBDT, "BDT50",
   ...
   if (Use["BDT50D"]) //
      factory->BookMethod( TMVA::Types::kBDT, "BDT50D",
                           "!H:!V:NTrees=50:MinNodeSize=5%:MaxDepth=3:BoostType=AdaBoost:SeparationType=GiniIndex:nCuts=20:VarTransform=Decorrelate" );
   if (Use["BDT50D10"]) //
      factory->BookMethod( TMVA::Types::kBDT, "BDT50D10",
                           "!H:!V:NTrees=50:MinNodeSize=10%:MaxDepth=3:BoostType=AdaBoost:SeparationType=GiniIndex:nCuts=20:VarTransform=Decorrelate" );
   if (Use["BDT20D10"]) //
      factory->BookMethod( TMVA::Types::kBDT, "BDT20D10",
                           "!H:!V:NTrees=20:MinNodeSize=10%:MaxDepth=3:BoostType=AdaBoost:SeparationType=GiniIndex:nCuts=20:VarTransform=Decorrelate" );
   if (Use["BDT20_10"]) // 
     factory->BookMethod( TMVA::Types::kBDT, "BDT20_10",
			  "!H:!V:NTrees=20:MinNodeSize=10%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=20" );
   if (Use["BDT20_5"]) // 
     factory->BookMethod( TMVA::Types::kBDT, "BDT20_5",
			  "!H:!V:NTrees=20:MinNodeSize=5%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=20" );

   if (Use["BDT50F"]) //
     factory->BookMethod( TMVA::Types::kBDT, "BDT50F",
                           "!H:!V:NTrees=50:MinNodeSize=5%:UseFisherCuts:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:SeparationType=GiniIndex:nCuts=20" );
   ...
   // After speaking with Paolo on July 11th, 2018
   if (Use["BDT_50_25_05"])
      factory->BookMethod( TMVA::Types::kBDT, "BDT_50_25_05",
   ...
   */
   ...
   if (Use["BDT_50_50_09"])
      factory->BookMethod( TMVA::Types::kBDT, "BDT_50_50_09",
                           "!H:!V:NTrees=50:MinNodeSize=5%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.9:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=20" );


   if (Use["BDTB_50"])
      factory->BookMethod( TMVA::Types::kBDT, "BDTB_50",
                           "!H:!V:NTrees=50:BoostType=Bagging:SeparationType=GiniIndex:nCuts=20" );
   if (Use["BDTB_80"])
      factory->BookMethod( TMVA::Types::kBDT, "BDTB_80",
                           "!H:!V:NTrees=80:BoostType=Bagging:SeparationType=GiniIndex:nCuts=20" );
   if (Use["BDTB_100"])
      factory->BookMethod( TMVA::Types::kBDT, "BDTB_100",
                           "!H:!V:NTrees=100:BoostType=Bagging:SeparationType=GiniIndex:nCuts=20" );
...
int main( int argc, char** argv )
{
   ...
   return TMVAClassificationANN(methodList); 
}
